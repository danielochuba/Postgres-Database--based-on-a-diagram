...
# 📖 [Postgres-Database--based-on-a-diagram] <a name="about-project"></a>


**[Postgres-Database--based-on-a-diagram]** IS a relational database created as the data structure for a clinic. that contains tables of patients, treatments, invoices, medical_histories, and invoice_items information.
...
Feel free to check the [issues page](https://github.com/danielochuba/Postgres-Database--based-on-a-diagram/issues).
